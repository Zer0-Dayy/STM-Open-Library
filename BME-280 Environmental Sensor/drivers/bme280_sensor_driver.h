...
// The breakout typically uses SDO pulled low -> 0x76. If SDO is pulled high, use HIGH.
...
// Calibration constants read from the device to convert raw counts to compensated values.
typedef struct
{
    uint16_t dig_T1;
    int16_t dig_T2;
